  ...
  return (
    <div className="flex items-center justify-between p-4 bg-[#fff]">
      <div className="flex items-center space-x-4">
        <img src="/assets/logo.png" alt="Logo" className="h-12 w-15" />{" "}
        {/* Updated logo path */}
      ...
      <div className="flex items-center space-x-2">
        <button className="bg-red-100 text-red-700 hover:bg-red-500/80 transition-all rounded-md px-4 py-2">
          Subscribe
        </button>
        <button className="bg-red-500 text-white hover:bg-opacity-80 rounded-md px-4 py-2">
          Sign in
        </button>
      </div>
    </div>
